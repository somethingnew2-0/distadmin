...
.. code-block:: bash
    ...
    heroku run python distadmin/manage.py syncdb --noinput --settings=config.settings
    heroku run python distadmin/manage.py migrate --settings=config.settings
    heroku run python distadmin/manage.py collectstatic --settings=config.settings
